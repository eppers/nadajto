                ...
                <div id="top">
                        ...
                        <div id="top-container">
                            <ul id="mainmenu">
                                    ...
                                    <li><a href="/admin/faktury">Faktury</a></li>
                                    <li><a href="/admin/klienci">Klienci</a></li>
                                    {% if session.user.id_customer %}<li><a href="/wyloguj">Wyloguj</a></li>{% endif %}                                
                            </ul>
                            <p id="loginpass" class="logged">
                                    ...
                                    {% if session.user.id_customer %}Zalogowany(a): <a href="/admin/" style="text-align: left;">Admin</a>{% endif %}
                            </p>
                        </div>
